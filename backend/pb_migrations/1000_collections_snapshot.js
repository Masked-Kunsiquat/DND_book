  ...
  const snapshot = [
    ...
    },
    {
      ...
      "fields": [
        ...
        {
          "cascadeDelete": false,
          "collectionId": "pbc_4165000482",
          "hidden": false,
          "id": "relation1349490569",
          "maxSelect": 999,
          "minSelect": 0,
        ...
        {
          "cascadeDelete": false,
          "collectionId": "pbc_245188654",
          "hidden": false,
          "id": "relation697315230",
          "maxSelect": 999,
          "minSelect": 0,
          "name": "npcs",
          "presentable": false,
    ...
    },
    {
      ...
      "type": "view",
      "updateRule": null,
      "viewQuery": "SELECT \n    (ROW_NUMBER() OVER()) AS id,\n    notes.id AS related_id,\n    notes.title AS related_name,\n    'note' AS related_type,\n    notes.tags AS tag_ids\nFROM notes;\n",
      "viewRule": "@request.auth.id != \"\""
    },
    {
      "createRule": null,
      ...
      "type": "view",
      "updateRule": null,
      "viewQuery": "SELECT \n    (ROW_NUMBER() OVER()) AS id,\n    locations.id AS related_id,\n    locations.name AS related_name,\n    'location' AS related_type,\n    locations.tags AS tag_ids\nFROM locations",
      "viewRule": "@request.auth.id != \"\""
    },
    {
      "createRule": null,
      ...
      "indexes": [],
      "listRule": "@request.auth.id != \"\"",
      "name": "tagged_sessions",
      "system": false,
      "type": "view",
      "updateRule": null,
      "viewQuery": "SELECT \n    (ROW_NUMBER() OVER()) AS id,\n    session_logs.id AS related_id,\n    session_logs.title AS related_name,\n    'session_log' AS related_type,\n    session_logs.tags AS tag_ids\nFROM session_logs\n",
      "viewRule": "@request.auth.id != \"\""
    },
    {
      "createRule": null,
